...
If you are new to Nethermind and need help getting started, join our [Discord](http://discord.gg/PaCMRFdvWT). Our developers are on hand to answer your questions. Don't hesitate to do a PR or raise other issues on the [Nethermind GitHub repository](https://github.com/NethermindEth/nethermind).
